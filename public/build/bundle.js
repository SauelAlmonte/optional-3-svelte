    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(input0, "class", "svelte-1de2ypb");
    			add_location(input0, file, 60, 2, 982);
    			attr_dev(input1, "placeholder", "What needs to be done?");
    			input1.disabled = input1_disabled_value = /*todo*/ ctx[6].done;
    			attr_dev(input1, "class", "svelte-1de2ypb");
    			add_location(input1, file, 65, 2, 1041);
    			attr_dev(div, "class", "svelte-1de2ypb");
    			add_location(div, file, 59, 1, 974);
    		},
    		...
    		p: function update(new_ctx, dirty) {
    			...
    			if (dirty & /*todos*/ 1 && input1_disabled_value !== (input1_disabled_value = /*todo*/ ctx[6].done)) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(59:0) {#each todos as todo}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h1, "class", "svelte-1de2ypb");
    			add_location(h1, file, 56, 0, 935);
    			attr_dev(p, "class", "svelte-1de2ypb");
    			add_location(p, file, 73, 0, 1159);
    			attr_dev(button0, "class", "svelte-1de2ypb");
    			add_location(button0, file, 75, 0, 1189);
    			attr_dev(button1, "class", "svelte-1de2ypb");
    			add_location(button1, file, 79, 0, 1233);
    		},
